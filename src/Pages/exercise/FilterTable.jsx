        ...
        <Box fontSize="12px" w={{base:"80%", md:"70%", lg:"60%"}} margin="auto">
            ...
            <Flex>
                <Grid  w="33%" templateColumns={{base:"repeat(1,1fr)", md:"repeat(2, 1fr)", lg:"repeat(2,1fr)"}} alignItems="center">
                    ...
                    <Flex flexDirection="column" alignItems="flex-start">
                        <Box>
                            <input type="checkbox" name="Strength" className="all" value="strength"  checked={type.includes("strength")} onChange={handleChange}/>
                            <label htmlFor="Strength">Strength</label>
                        </Box>
                        <Box>
                            <input type="checkbox" name="Stretching" className="all" value="stretching"  checked={type.includes("stretching")} onChange={handleChange}/>
                            <label htmlFor="Stretching">Stretching</label>
                        </Box>
                        <Box>
                            <input type="checkbox" name="Powerlifting" className="all" value="powerlifting"  checked={type.includes("powerlifting")} onChange={handleChange}/>
                            <label htmlFor="Powerlifting">Powerlifting</label>
                        </Box>
                        <Box>
                            <input type="checkbox" name="Olympic Weight Lifting" className="all" value="olympicweightLifting"  checked={type.includes("olympicweightLifting")} onChange={handleChange}/>
                ...
                <Grid  w="33%" templateColumns={{base:"repeat(1,1fr)", md:"repeat(2, 1fr)", lg:"repeat(2,1fr)"}} alignItems="center">
                    ...
                    <Flex flexDirection="column" alignItems="flex-start">
                        <Box>
                            <input type="checkbox" name="Beginner" className="all" value="beginner" checked={difficulty.includes("beginner")} onChange={handleChange}/>
                            <label htmlFor="Beginner">Beginner</label>
                        </Box>
                        <Box>
                            <input type="checkbox" name="Intermediate" className="all" value="intermediate" checked={difficulty.includes("intermediate")} onChange={handleChange}/>
                            <label htmlFor="Intermediate">Intermediate</label>
                        </Box>
                        <Box>
                            <input type="checkbox" name="Expert" className="all" value="expert" checked={difficulty.includes("expert")} onChange={handleChange}/>
