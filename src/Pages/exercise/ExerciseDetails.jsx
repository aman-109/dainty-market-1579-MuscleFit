            ...
            <Box w={{base:"100%", md:"100%", lg:"75%"}}>
                <Flex flexDirection="column">
                    <Flex textAlign="left" fontSize="14px">
                        <Text color="rgb(68, 188, 231)">{dt.main_group} Exercise Database <span style={{color:"rgb(136, 136, 136)"}}>{k} {dt.name}</span> </Text>
                        <Text></Text>
                    </Flex>
                    <Box textAlign="left" borderBottom="1px solid rgb(222, 226, 230)">
                        <Text fontSize="24px" color="rgb(14, 112, 154)">{dt.name} Images</Text>
                    </Box>
                    <Flex mt="10px" gap="10px" flexDirection={{base:"column", md:"column", lg:"row"}}>
                        <Flex flexDirection="column" w={{base:"90%", md:"90%", lg:"45%"}} gap="10px">
                            {
                                dt.image_urls && dt.image_urls.map((el,i)=>(
                        ...
                        <Flex textAlign="left"  flexDirection="column" w={{base:"90%", md:"90%", lg:"50%"}} gap="10px">
                            ...
                            <Flex textAlign="left" flexDirection="column" fontSize="14px" gap="5px" padding="10px">
                                <Text color="rgb(85, 85, 85)"as="b">Main Muscle Group : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.main_group}</span></Text>
                                <Text color="rgb(85, 85, 85)"as="b">Detailed Muscle Group : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.detailed_group}</span></Text>
                                <Text color="rgb(85, 85, 85)"as="b">Other Muscle Groups : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.other_group}</span></Text>
                                <Text color="rgb(85, 85, 85)"as="b">Type : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.type}</span></Text>
                                <Text color="rgb(85, 85, 85)"as="b">Mechanics : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.Mechanics}</span></Text>
                                <Text color="rgb(85, 85, 85)"as="b">Equipment : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.equipment}</span></Text>
                                <Text color="rgb(85, 85, 85)"as="b">Difficulty : <span style={{color:"rgb(132, 133, 134)", fontWeight:"400"}}>{dt.difficulty}</span></Text>
                            </Flex>
