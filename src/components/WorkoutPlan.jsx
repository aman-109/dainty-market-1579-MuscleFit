...
export const WorkoutPlan=()=>{
    ...
    return <>
     <Container maxW='100%'  pt={14} pb={14} mt={16} bg='#F8FBFE'>
        ...
        <Button mt={4}  pl={6} pr={6}  variant='solid' bg='#39B7FF' color='white' fontFamily='Montserrat, sans-serif' fontSize='20px'  style={{fontWight:'700',borderRadius:"20px"}}>CREATE WORKOUT PLAN</Button>
